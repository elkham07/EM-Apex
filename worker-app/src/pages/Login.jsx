  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh', background: '#121212', color: '#fff', fontFamily: 'Inter, sans-serif' }}>
      <div className="auth-box" style={{ background: '#1e1e1e', padding: '40px', borderRadius: '12px', width: '400px', textAlign: 'center', border: '1px solid rgba(255,255,255,0.1)' }}>
        ...
        <input type="password" id="password" className="search-input" style={{ width: '100%', marginBottom: '15px' }} placeholder="Enter your password" />
        <button id="login-btn" className="btn-upgrade-main" style={{ width: '100%', background: 'var(--accent)', color: '#fff', padding: '14px' }} onClick={() => window.location.href = '/'}>Log In</button>
      </div>
    </div>
  )
}
